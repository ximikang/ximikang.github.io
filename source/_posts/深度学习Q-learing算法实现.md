...
# 深度学习Q-learing算法实现
## 1. 问题分析
![在这里插入图片描述](https://img-blog.csdnimg.cn/20181226155801504.png)
...
## 3. 算法实现
**参考以下伪代码：**
![在这里插入图片描述](https://img-blog.csdnimg.cn/20181226155811951.png)
具体程序如见附录
**程序的关键点：**
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20181226155818775.png)
